...
const AppHome: React.FC = () => {
  // Phases: intro -> experiment -> emotion -> questionnaire -> summary
  const [phase, setPhase] = useState<"intro" | "experiment" | "emotion" | "questionnaire" | "summary">("intro");
          ...
          <Card className="max-w-2xl w-full mx-auto border-2 shadow-xl bg-white/90 backdrop-blur-sm ring-1 ring-blue-300">
            ...
            <CardContent className="text-base text-blue-700 text-center bg-white rounded-md px-2 py-1">
              ...
              <div className="mb-3 px-3 py-2 bg-yellow-50 border border-yellow-200 rounded-lg text-sm text-yellow-800">
                📱 Please turn off <b>dark mode</b> and set your screen brightness to <b>maximum</b> before starting!
              </div>
